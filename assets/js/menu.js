...
const menus = [
...

    {
        ...
        description: "Un menu 100% végétal, équilibré et savoureux, adapté à toutes les occasions.",
        theme: "Vegan",
        regime: "Vegan",
        ...
        entrees: [
            { nom: "Salade fraîcheur aux légumes croquants", allergenes: [] },
            { nom: "Houmous et ses crudités", allergenes: ["Sésame"] }
        ],

        plats: [
            { nom: "Curry de légumes au lait de coco", allergenes: [] },
            { nom: "Pâtes complètes sauce tomate basilic", allergenes: ["Gluten"] }
        ],

        desserts: [
            { nom: "Mousse au chocolat vegan", allergenes: [] },
            { nom: "Tartelette fruits rouges (sans lactose)", allergenes: ["Gluten"] }
        ],
...

    {
        ...
        description: "Un menu conçu pour vos fêtes, anniversaires et grands rassemblements.",
        theme: "Événements",
        regime: "Classique",
        ...
        personnesMin: 6,
        prix: 90,
        conditions: "À commander 3 jours avant. Prévoir stockage au frais.",
        stock: 10
    }
];
